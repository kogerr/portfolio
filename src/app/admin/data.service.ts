...
export class AdminDataService {
    ...
    addAboutElement(element: { [type: string]: IndexedText | PossiblyClickable | HeaderAndLines }): Observable<SuccessFlag> {
        return this.http.put<SuccessFlag>(aboutURL, element);
    }

    removeAboutElement(element: { [type: string]: IndexedText | PossiblyClickable | HeaderAndLines }): Observable<SuccessFlag> {
        let httpOptions = {
